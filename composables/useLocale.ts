...
const messages: Record<Locale, Dict> = {
  fr: {
    ...
    'nav.sightsSounds': 'Univers visuel & sonore',
    'nav.forGood': 'Engagement solidaire',
    'nav.reviews': 'Avis & presse',
    'nav.faq': 'FAQ',
    'stub.comingSoon': 'Contenu à venir — page en construction.',

    'hero.bookNow': 'Réserver mes billets',
  ...
  en: {
    ...
    'nav.story': 'The Story',
    'nav.sightsSounds': 'Sights & Sounds',
    'nav.forGood': 'For Good',
    'nav.reviews': 'Reviews',
    'nav.faq': 'FAQ',
