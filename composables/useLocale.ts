...
const messages: Record<Locale, Dict> = {
  ...
  en: {
    ...
    'form.smsConsent':
      'Yes, text me about Miraculous Ladybug Live tour dates and tickets. Message frequency may vary. Standard message and data rates may apply. Reply STOP to opt out, HELP for help. We will not sell or share your mobile information with third parties for promotional purposes.',
